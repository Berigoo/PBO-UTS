...
public class Main {
    public static void main (String[] args) {
        //so-called database
        List<Pengguna> db = new ArrayList<Pengguna>(Arrays.asList(new Pengguna[]{new User("anon", "securePass"),
        new Admin("admin", "admin")}));
        List<Buku> dbBuku = new ArrayList<Buku>(Arrays.asList(new Buku[]{new Buku("Forbidden Scrollery Vol.1", new String[]{"Fantasy", "Supernatural", "Mystery"}),
        new Buku("Over Rev", new String[]{"Suggestive", "Action", "Sports"})}));
                ...
                do {
                    ...
                    switch (pilihan) {
                        ...
                        case 2:
                            ...
                            String sGenre = input.nextLine();
                            String[] genre = sGenre.split(" ");
                            ((Admin) db.get(loginIndex)).addBuku(dbBuku, title, genre);     //trust me, compiler
                            break;
                        case 3:
                            System.out.println("\nHapus Buku\n");
                            System.out.print("Masukan nomor buku: ");
                            int index = input.nextInt();
                            ((Admin) db.get(loginIndex)).delBuku(dbBuku, index);
                            break;
                        case 4:
                            break;
                        case 5:
